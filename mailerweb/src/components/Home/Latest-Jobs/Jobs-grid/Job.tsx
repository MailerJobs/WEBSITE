...
const Job = (props) => {
  return (
    <div className="flex flex-col border-solid border-2 rounded-md py-7 px-6 gap-5 w-[550px] h-[350px]">
              <div className="flex gap-8">
                <div className="flex flex-col w-[170px]">
                  <h1 className="text-xl font-bold">{props.element.job_title}</h1>
                  <div>
                  ...
                  <div className="flex items-center">
                    <img
                      ...
                      className="w-4 h-5"
                    />
                    <div className="text-gray-500 max-w-[170px] text-wrap font-medium ml-1">
              ...
              <div className="flex justify-around">
                <div className="flex flex-col gap-1 items-center justify-center w-32 h-20 text-gray-800 border-solid border-2 rounded-md">
                  <h1 className="font-medium">Experience</h1>
                  <h2>{props.element.experience}</h2>
                </div>
                <div className="flex flex-col justify-center items-center w-32 h-20 text-gray-800 border-solid border-2 rounded-md">
